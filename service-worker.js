const CACHE_NAME='minimal-composer-v0.4.21';
const APP_SHELL=['./','./index.html','./manifest.webmanifest','./minimal-icon-180.png','./minimal-icon-192.png','./minimal-icon-512.png','./icon.svg'];
